...
{
	public partial class view_report_transferencia : System.Web.UI.Page
	{
		...
		public void LoadReporte()
		{
            ...
            if (id == "20" )
            {
                this.documento.SetParameterValue(0, Convert.ToInt32(Request.QueryString["id_cliente"]));
              
            }
            if (id == "22")
            {
                this.documento.SetParameterValue(0, Convert.ToInt32(Request.QueryString["id_solicitud"]));
                this.documento.OpenSubreport("seguimiento_estado");
            ...
            if (id == "24" )
            {
                ...
                this.documento.OpenSubreport("seguimiento_estado");
                this.documento.SetParameterValue(1, Convert.ToInt32(Request.QueryString["id_solicitud"]));
                this.documento.OpenSubreport("seguimiento_estado_prenda_20190");
