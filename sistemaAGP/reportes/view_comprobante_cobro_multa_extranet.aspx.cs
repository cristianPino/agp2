...
namespace sistemaAGP.reportes
{
    ...
    public partial class view_comprobante_cobro_multa_extranet : System.Web.UI.Page
    {
        ...
        public  void Page_Load(object sender, EventArgs e)
        {
            ...
            id_solicitud = Request.QueryString["id_solicitud"].ToString();
            


            ReportDocument rpt = new ReportDocument();
            rpt.Load(Server.MapPath("InfComprobanteGastoMulta.rpt"));
            ...
            rpt.OpenSubreport("Detalle_Multas");
            rpt.SetParameterValue(2, id_solicitud);

            LoadReport(rpt, "InfComprobanteGastoMulta.rpt","N");
