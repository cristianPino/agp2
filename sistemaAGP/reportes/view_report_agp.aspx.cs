...
{
	public partial class view_report_agp : System.Web.UI.Page
	{
		...
		public void LoadReporte()
		{
			...
			this.documento.SetParameterValue("@rut_adquiriente", Convert.ToInt32(Request.QueryString["rut_adquiriente"]));
			this.documento.SetParameterValue("@numero_factura", Convert.ToInt32(Request.QueryString["numero_factura"]));
