<%@ Page Title="Control de Operaciones AGP S.A." Language="C#" MasterPageFile="~/AGP.Master" AutoEventWireup="true" CodeBehind="reporteador.aspx.cs" Inherits="sistemaAGP.reporteador" %>
			...
			<td class="style4" style="height: 74px" valign="top">
				<table style="width: 100%; height: 32px;" bgcolor="#507CD1">
					<tr>
						...
						<td style="font-family: Arial, Helvetica, sans-serif; font-size: x-small; height: 28px; width: 95px;">
							<b>
						...
						<tr>
							<td style="width: 123px;" valign="top">
								...
								<asp:gridview id="gr_dato" runat="server" autogeneratecolumns="False" cellpadding="4"
									...
									datakeynames="id_informe,nombre" onselectedindexchanged="gr_dato_SelectedIndexChanged"
