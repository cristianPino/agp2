		...
		<ContentTemplate>
			<asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" CellPadding="4"
				...
				<Columns>
									...
									<tr>
										...
										<td>
											<asp:HyperLink ID="lnk_cargar" runat="server" data-fancybox-type="iframe" CssClass="fancybox_grande fancybox.iframe"
												ToolTip="Carpeta dígital" ImageUrl="~/imagenes/iconos/cargar.png" NavigateUrl='<%# Bind("url_cargar") %>' />
										</td>										
										<td>
					...
					<asp:BoundField DataField="numero_cliente" HeaderText="Nº Cliente" />
					...
					<asp:BoundField DataField="n_repertorio" HeaderText="Nº Repertorio" />
					...
					<asp:TemplateField AccessibleHeaderText="Eliminar" HeaderText="Eliminar">
						<ItemTemplate>
							...
							<ajaxToolkit:ConfirmButtonExtender ID="cfe_eliminar" runat="server" ConfirmText="¿Está seguro de eliminar la operación?" TargetControlID="bt_eliminar">
						...
						<%--	<td style="padding: 0 4px; width: 100px; text-align: center;">
							...
							<td style="padding: 4px; width: 100px; text-align: center;">
								<asp:ImageButton ID="ib_nomina_desactivar" runat="server" ImageUrl="~/imagenes/sistema/static/panel_control/nominas.png"
									ToolTip="Desactivar Nómina" Style="background-color: #ffffff; padding: 2px; border: 1px solid #cccccc;"
