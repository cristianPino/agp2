<%@ Page Title="Control de Operaciones AGP S.A." Language="C#" MasterPageFile="~/AGP.Master" AutoEventWireup="true" CodeBehind="CargaCarpetaEjeCliente.aspx.cs" Inherits="sistemaAGP.CargaCarpetaEjeCliente" %>
			...
			<div style="background-color: #507cd1; font-family: Arial, Helvetica, sans-serif; font-size: x-small; color: #ffffff;">
				<table>
					<tr>
						...
						<td style="vertical-align: middle;">
							<asp:TextBox ID="txt_cliente" runat="server" AutoPostBack="true" Style="font-family: Arial, Helvetica, sans-serif; font-size: x-small; width: 135px;" ontextchanged="txt_cliente_TextChanged"></asp:TextBox>
						</td>
						<td style="vertical-align: middle;">
	...
	<asp:UpdatePanel ID="up_grilla" runat="server">
		<ContentTemplate>
			<asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" 
				...
				Width="100%" onselectedindexchanged="gr_dato_SelectedIndexChanged1" OnRowDataBound="gr_dato_RowDataBound" >
					...
					<asp:TemplateField HeaderText="Cargar">
						<ItemTemplate>
							<asp:HyperLink ID="lnk_cargar" runat="server" data-title-id="title-cargar" data-fancybox-type="iframe"
								CssClass="fancybox fancybox.iframe" ImageUrl="~/imagenes/sistema/static/panel_control/subir.png"
