<%@ Page Title="Control Factura de Operaciones AGP S.A." Language="C#" MasterPageFile="~/AGP.Master"
	AutoEventWireup="true" CodeBehind="control_operaciones_factura.aspx.cs" Inherits="sistemaAGP.control_operaciones_factura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoCentral" runat="server">
									...
									<table style="width: 100%" bgcolor="#507CD1">
										<tr>
											...
											<td style="font-family: Arial, Helvetica, sans-serif; font-size: x-small; width: 43px; color: #FFFFFF;">
												Cliente
											</td>
											<td>
												<asp:DropDownList ID="ddlCliente" runat="server" Font-Names="Arial" Font-Size="X-Small"
													Height="16px" Width="200px" Style="font-family: Arial, Helvetica, sans-serif;
										...
										<tr>
											...
											<td>
												<asp:DropDownList ID="dpl_nomina" runat="server" Font-Names="Arial" Font-Size="X-Small"
													Height="16px" Width="200px" OnSelectedIndexChanged="dpl_nomina_SelectedIndexChanged">
												</asp:DropDownList>
											</td>
											<td style="width: 74px; font-family: Arial, Helvetica, sans-serif; font-size: x-small;
												height: 28px; color: #FFFFFF; text-align: left;">
				...
				<table style="width: 100%" bgcolor="Gray">
					<tr>
						<td>
						...
						<td style="width: 100%;">
									...
									<asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" CellPadding="4"
										...
										<Columns>
											...
											<asp:BoundField AccessibleHeaderText="Folio_Nom" DataField="folio" HeaderText="Folio_Nom" />
