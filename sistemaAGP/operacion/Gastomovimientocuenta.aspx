<%@ Page Title="" Language="C#" MasterPageFile="~/Adm.Master" AutoEventWireup="true" CodeBehind="Gastomovimientocuenta.aspx.cs" Inherits="sistemaAGP.Gastomovimientocuenta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
		...
		<table style="width: 81%; font-family: Arial, Helvetica, sans-serif; font-size: x-small; background-color: #E5E5E5;">
		</table>
		<table style="width: 42%; font-family: Arial, Helvetica, sans-serif; font-size: x-small; background-color: #E5E5E5;">
			<tr>
				<td class="style4">
					Nº Operacion
				</td>
