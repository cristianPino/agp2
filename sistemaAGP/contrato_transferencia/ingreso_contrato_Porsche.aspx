<%@ Page Title="Ingreso Solicitud de Transferencia" Language="C#" MasterPageFile="~/Adm.Master"
	AutoEventWireup="true" CodeBehind="ingreso_contrato_Porsche.aspx.cs" Inherits="sistemaAGP.ingreso_contrato_Porsche" %>
			...
			<td style="width: 789px; height: 20px" valign="top">
				...
				<table>
					<tr>
                        ...
                        <td style="width: 73px; font-family: Arial, Helvetica, sans-serif; font-size: x-small;">
                            <asp:TextBox ID="txt_numero_emisor" runat="server" Width="72px"></asp:TextBox>  
				...
				<asp:Panel ID="id_datounico" runat="server">
					<table>
						...
						<tr>
							...
							<td>
								<asp:DropDownList ID="dl_marca_vehiculo" runat="server" Font-Names="Arial" AutoPostBack="true"
									Font-Size="X-Small" Height="16px" Width="139px" Style="font-family: Arial, Helvetica, sans-serif;
									font-size: x-small" OnSelectedIndexChanged="dl_marca_vehiculo_SelectedIndexChanged">
								</asp:DropDownList>
							...
							<td>
								<asp:TextBox ID="txt_chassis" runat="server"></asp:TextBox>
							</td>
						</tr>
						<tr>
							<td style="font-size: x-small; font-family: Arial, Helvetica, sans-serif">
							...
							<td>
								<asp:TextBox ID="txt_motor" runat="server"></asp:TextBox>
							</td>
							<td style="font-size: x-small; font-family: Arial, Helvetica, sans-serif">
								Color
							</td>
							...
							<td>
								<asp:TextBox ID="txt_anno" runat="server"></asp:TextBox>
							</td>
							<td style="font-size: x-small; font-family: Arial, Helvetica, sans-serif">
								T. Combustible
							</td>
							<td>
								<asp:DropDownList ID="dl_combustible" runat="server" Style="font-family: Arial, Helvetica, sans-serif;
						...
						<tr>
							...
							<td>
								<asp:TextBox ID="txt_p_bruto" runat="server"></asp:TextBox>
							</td>
						</tr>
						<tr>
				...
				<table>
					<tr>
						<td>
							...
							<ajaxToolkit:ConfirmButtonExtender ID="bt_guardar_ConfirmButtonExtender" runat="server" TargetControlID="bt_guardar" ConfirmText="¿Esta seguro de ingresar un nuevo contrato de transferencia?">
