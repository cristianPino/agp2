<%@ Page Title="Control de Operaciones AGP S.A." Language="C#" MasterPageFile="~/AGP.Master"
	AutoEventWireup="true" CodeBehind="Activacion_prepago.aspx.cs" Inherits="sistemaAGP.Activacion_prepago" %>
				...
				<center>
					<table style="width: 100%; height: 264px;">
						<tr>
								...
								<asp:UpdatePanel ID="UpdatePanel2" runat="server">
									<ContentTemplate>
										<asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" CellPadding="4"
											Font-Names="Arial" Font-Size="X-Small" ForeColor="#333333" DataKeyNames="tipo_operacion,cliente,operacion,habilitada,dl_Cambioproducto,dl_financiera"
											...
											<Columns>
												<asp:BoundField AccessibleHeaderText="Operacion" DataField="operacion" 
                                                    HeaderText="Operacion" Visible="False" />
												...
												<ItemTemplate>
													<asp:ImageButton ID="ib_ventas" runat="server" ImageUrl="../imagenes/sistema/static/primera.bmp"
														OnClick="Click_ventas" Text="Ventas" />
												</ItemTemplate>
												<ControlStyle Height="25px" Width="25px" />
											</asp:TemplateField>
							...
							<ItemTemplate>
								<asp:DropDownList ID="dl_financiera" MaxLength="120" Height="16px" runat="server" Width="120px" Font-Size="7pt" AutoPostBack="False" OnDataBound="gvExample_DataBound" >
                                <asp:ListItem Value="00">Seleccionar..</asp:ListItem>
                               <asp:ListItem Value="SAN">SANTANDER CONSUMER</asp:ListItem>
                                            <asp:ListItem Value="MCRE">MARUBENI CREDIT (MASFIN)</asp:ListItem>
                                            <asp:ListItem Value="MUNCR">MUNDOCREDITO</asp:ListItem>
                                            <asp:ListItem Value="BFALA">BANCO FALABELLA</asp:ListItem>
                                            <asp:ListItem Value="MITS">MITSUI</asp:ListItem>
                                            <asp:ListItem Value="ASTR">ASTRA</asp:ListItem>
                                            <asp:ListItem Value="FOR">FORUM</asp:ListItem>
                                            <asp:ListItem Value="TANN">TANNER</asp:ListItem>
                                            <asp:ListItem Value="SCO">SCOTIABANK</asp:ListItem>
								</asp:DropDownList>
							</ItemTemplate>
							<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            ...
                                            <asp:TemplateField HeaderText="Cambiar producto" meta:resourcekey="TemplateFieldResource1">
							<ItemTemplate>
								<asp:DropDownList ID="dl_Cambioproducto" MaxLength="120" Height="16px" runat="server" Width="120px" Font-Size="7pt" AutoPostBack="True" OnSelectedIndexChanged="dl_Cambioproducto_SelectedIndexChanged">
                               <asp:ListItem Value="00">Seleccionar..</asp:ListItem>
                               <asp:ListItem Value="CTM">Contrato Toma</asp:ListItem>
                                            <asp:ListItem Value="PREP">Toma con Prepago</asp:ListItem>
								</asp:DropDownList>
							</ItemTemplate>
							<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
						</asp:TemplateField>
												...
												<asp:BoundField AccessibleHeaderText="habilitada" DataField="habilitada" 
													HeaderText="habilitada" Visible="false" />
