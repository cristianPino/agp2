<%@ Page Language="C#" MasterPageFile="~/Adm.Master" AutoEventWireup="true" CodeBehind="mValorseguro.aspx.cs"
	Inherits="sistemaAGP.mValorseguro" Title="valores seguro" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
	...
	<div>
			...
			<tr>
				...
				<td>
					<asp:TextBox ID="txt_fecha_inicio" runat="server" Style="font-family: Arial, Helvetica, sans-serif;
						font-size: x-small" Height="18px" Width="128px" TabIndex="7" 
						OnTextChanged="txt_fecha_inicio_TextChanged"></asp:TextBox>
				...
				<td>
					<asp:TextBox ID="txt_fecha_final" runat="server" Style="font-family: Arial, Helvetica, sans-serif;
						font-size: x-small" Height="17px" Width="92px" TabIndex="7" 
						OnTextChanged="txt_fecha_final_TextChanged"></asp:TextBox>
		...
		<asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" CellPadding="4"
			...
			<Columns>
				...
				<asp:TemplateField HeaderText="valor" meta:resourcekey="TemplateFieldResource1">
					<ItemTemplate>
						<asp:TextBox ID="txt_valor" MaxLength="6" Height="16px" runat="server" Text='<%# Bind("valor") %>'
							Width="50px" AutoCompleteType="Disabled" Font-Size="7pt" OnTextChanged="txt_valor_Leave" 
							meta:resourcekey="txt_valorResource1"></asp:TextBox>
						<cc1:FilteredTextBoxExtender ID="txt_valor_FilteredTextBoxExtender" runat="server"
							TargetControlID="txt_valor" FilterType="Custom, Numbers" Enabled="True">
	...
	<table>
		...
		<tr>
			<td class="style8">
				<asp:Button ID="id_buscar" runat="server" Text="Buscar" Font-Size="X-Small" OnClick="bt_buscar_Click"
					UseSubmitBehavior="False" meta:resourcekey="bt_buscarResource1" Style="height: 21px" />
					</td>
			<td class="style8">
				...
				<cc1:ConfirmButtonExtender ID="bt_guardar_ConfirmButtonExtender" runat="server" TargetControlID="bt_guardar"
					ConfirmText="¿Esta seguro de editar los vaoles de este Distribuidor?" Enabled="True">
				</cc1:ConfirmButtonExtender>
			</td>
		</tr>
	</table>
		<table style="font-family: Arial, Helvetica, sans-serif; font-size: x-small; height: 26px;"
			...
			<asp:GridView ID="gr_dato2" runat="server" AutoGenerateColumns="False" CellPadding="4"
				...
				OnSelectedIndexChanged="gr_dato2_SelectedIndexChanged" meta:resourcekey="gr_dato2Resource1" Visible="False">
				<RowStyle BackColor="#EFF3FB" />
				<Columns>
