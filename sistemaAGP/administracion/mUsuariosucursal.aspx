<%@ Page Language="C#" MasterPageFile="~/Adm.Master" AutoEventWireup="true" CodeBehind="mUsuariosucursal.aspx.cs" Inherits="sistemaAGP.mUsuariosucursal" Title="Administracion de Sucursales / Usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
			...
			<asp:TemplateField AccessibleHeaderText="Encargado" FooterText="Encargado" 
				HeaderText="Encargado">
				
				<ItemTemplate>
					<asp:CheckBox ID="chk2" runat="server" EnableViewState="true" Checked='<%# Bind("check_encargado")  %>' />
				</ItemTemplate>
			</asp:TemplateField>
			
			<asp:TemplateField AccessibleHeaderText="Supervisor" FooterText="Supervisor" 
				HeaderText="Supervisor">
				
				<ItemTemplate>
					<asp:CheckBox ID="chksup2" runat="server" EnableViewState="true" Checked='<%# Bind("check_supervisor")  %>' />
				</ItemTemplate>
			</asp:TemplateField>
