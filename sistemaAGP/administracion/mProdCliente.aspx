<%@ Page Language="C#" MasterPageFile="~/Adm.Master" AutoEventWireup="true" CodeBehind="mProdCliente.aspx.cs" Inherits="sistemaAGP.mProdCliente" Title="administracion tipos de productos" %>
...
<cc1:ConfirmButtonExtender ID="Button1_ConfirmButtonExtender" 
            ...
            ConfirmText="¿Esta seguro de ingresar un nuevO Producto?"
            >
...
<asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        <asp:BoundField AccessibleHeaderText="id_producto_cliente" DataField="id_producto_cliente" 
            HeaderText="id_producto_cliente" />
