<%@ Page Language="C#" MasterPageFile="~/AGP.Master" AutoEventWireup="true" CodeBehind="mCiudad.aspx.cs" Inherits="sistemaAGP.mCiudad" Title="Administracion de Ciudades" %>
        ...
        <tr>
            <td style="border-style: none; border-color: inherit; border-width: 0; text-align: left; width: 1057px; height: 277px;" align="left" 
                ...
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" 
                        Font-Size="X-Small" Text="Administracion de Ciudades"></asp:Label>
                <br />
                ...
                <cc1:ConfirmButtonExtender ID="Button1_ConfirmButtonExtender" runat="server" 
                        ...
                        ConfirmText="¿Esta seguro de ingresar una nueva Ciudad?" >
                ...
                <asp:GridView ID="gr_dato" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField AccessibleHeaderText="id_ciudad" DataField="id_ciudad" 
                                HeaderText="id_ciudad" />
