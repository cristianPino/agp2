<%@ Page Language="C#" MasterPageFile="~/Adm.Master" AutoEventWireup="true" CodeBehind="mPerfilopcionmenu.aspx.cs" Inherits="sistemaAGP.mPerfilopcionmenu" Title="Opciones de Menu para Perfil" %>
    ...
    <table>
        <tr>
            <td class="style4">
                Perfil</td>
            <td class="style4">
                <asp:Label ID="lbl_perfil" runat="server" Font-Names="Arial" 
