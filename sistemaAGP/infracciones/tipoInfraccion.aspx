...
<%@ Page Language="C#" MasterPageFile="~/AGP.Master" AutoEventWireup="true" CodeBehind="tipoInfraccion.aspx.cs" Inherits="sistemaAGP.tipoInfraccion" Title="AGP S.A. / Administracion de Infracciones" %>
            ...
            <tr>
                <td style="border-style: none; border-color: inherit; border-width: 0; text-align: left; width: 968px; height: 277px;" align="left" 
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" 
                        Font-Size="X-Small" Text="Administracion de Infracciones"></asp:Label>
                    <br />
                    ...
                    <table style="width: 14%; font-family: Arial, Helvetica, sans-serif; font-size: x-small" 
                        ...
                        <tr>
                            <td style="width: 56px; text-align: right;">
                                Codigo  <td style="width: 126px; text-align: left">
                            ...
                            <td style="text-align: left; ">
                                <asp:TextBox ID="txt_nombre" runat="server" Font-Names="Arial" 
                                    Font-Size="X-Small" MaxLength="50" Width="190px" TabIndex="3"></asp:TextBox>
                                        </td>
                       </tr>
                        </table>
                    ...
                    <asp:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" 
                        ...
                        ConfirmText="¿Esta seguro de ingresar un tipo de Infraccion?" /> 
