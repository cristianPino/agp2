...
function initPara() {
    ...
    if (varActionPage) {
        if (location.hostname != "") {
            ...
            varActionPage.value = CurrentPathName.substring(0, CurrentPathName.lastIndexOf("/") + 1) + document.getElementById("txtActionPage").value; //the ActionPage's file path
        }
        else
            varActionPage.value = varActionPage.value; //the ActionPage's file path
    }
