<%@ Page Title="" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="Ingreso_garantia_ag.aspx.cs" Inherits="sistemaAGP.Ingreso_garantia_ag" Culture="es-CL" UICulture="es-CL" Theme="SkinAdm" %>
			...
			<div style="width: 100%;">
				...
				<ajaxToolkit:TabContainer ID="tab_datos" runat="server" Width="100%" 
					...
					<ajaxToolkit:TabPanel ID="tab_negocio" runat="server" HeaderText="Datos Negocio" Width="100%">
						<ContentTemplate>
							<asp:UpdatePanel ID="up_negocio" runat="server" UpdateMode="Conditional"><ContentTemplate>
									...
									<asp:Panel ID="pnl_datos_negocio" runat="server" Visible="False">
                                        ...
                                        <table class="tabla-normal">
										...
										</table><table class="tabla-normal">
											<table class="tabla-normal">
												<tr>
													...
													<td>
														<asp:TextBox ID="txt_factura" runat="server" Width="100px" OnTextChanged="txt_factura_TextChanged" AutoPostBack="True" MaxLength="10"></asp:TextBox>
													...
													<td>
														<asp:TextBox ID="txt_monto_factura" runat="server" Width="100px"  onkeyup="format(this);" onchange="format(this);" 
                                                            onblur="calcularMontoFinanciar();" ></asp:TextBox>
														<ajaxToolkit:FilteredTextBoxExtender ID="filter_motno_factura" runat="server" TargetControlID="txt_monto_factura" FilterType="Custom, Numbers"
														ValidChars='<%= System.Globalization.CultureInfo.CreateSpecificCulture("es-CL").NumberFormat.NumberGroupSeparator %>' Enabled="True" />
											...
											<asp:Panel ID="pnl_cheques" runat="server" Visible="false">
												<table class="tabla-normal">
													...
													<tr>
														...
														<td>
															<asp:TextBox ID="txt_pie" runat="server" MaxLength="10" Width="100px" onkeyup="format(this);" onchange="format(this);" onblur="calcularMontoFinanciar();"></asp:TextBox>
															<asp:RequiredFieldValidator ID="rfv_pie" runat="server" CssClass="error" Text="*" ErrorMessage="Monto Pie" ControlToValidate="txt_pie">
															</asp:RequiredFieldValidator>
															<ajaxToolkit:FilteredTextBoxExtender ID="filter_pie" runat="server" TargetControlID="txt_pie" FilterType="Custom, Numbers" ValidChars='<%= System.Globalization.CultureInfo.CreateSpecificCulture("es-CL").NumberFormat.NumberGroupSeparator %>' Enabled="True">
															</ajaxToolkit:FilteredTextBoxExtender>
														</td>
														<td>
														...
														<td>
															<asp:TextBox ID="txt_cheques" runat="server" MaxLength="2" Width="30px" OnTextChanged="txt_cheques_TextChanged" AutoPostBack="true"></asp:TextBox>
															<asp:RequiredFieldValidator ID="rfv_cheques" runat="server" CssClass="error" Text="*" ControlToValidate="txt_cheques"></asp:RequiredFieldValidator>
															<ajaxToolkit:FilteredTextBoxExtender ID="filter_cheques" runat="server" TargetControlID="txt_cheques" FilterType="Custom, Numbers" ValidChars='<%= System.Globalization.CultureInfo.CreateSpecificCulture("es-CL").NumberFormat.NumberGroupSeparator %>' Enabled="True">
															</ajaxToolkit:FilteredTextBoxExtender>
														</td>
														<td>
														...
														<td>
															<asp:TextBox ID="txt_primera" runat="server" Width="70px" OnTextChanged="txt_primera_TextChanged" AutoPostBack="true"></asp:TextBox>
															<asp:RequiredFieldValidator ID="rfv_primera" runat="server" CssClass="error" Text="*" ControlToValidate="txt_primera"></asp:RequiredFieldValidator>
														</td>
														<td>
														...
														<td>
															...
															<asp:RequiredFieldValidator ID="rfv_ultima" runat="server" CssClass="error" Text="*" ControlToValidate="txt_ultima"></asp:RequiredFieldValidator>
														</td>
														<td>
											...
											<table class="tabla-normal">
												...
												<tr>
													...
													<td>
														<asp:TextBox ID="txt_factura_intereses" runat="server" MaxLength="10" Width="100px" OnTextChanged="txt_factura_intereses_TextChanged" AutoPostBack="true"></asp:TextBox>
														<asp:RequiredFieldValidator ID="rfv_factura_intereses" runat="server" CssClass="error" Text="*" ErrorMessage="Nº Factura Intereses" ControlToValidate="txt_factura_intereses"></asp:RequiredFieldValidator>
														<ajaxToolkit:FilteredTextBoxExtender ID="filter_factura_intereses" runat="server" TargetControlID="txt_factura_intereses" FilterType="Custom, Numbers" ValidChars='<%= System.Globalization.CultureInfo.CreateSpecificCulture("es-CL").NumberFormat.NumberGroupSeparator %>' Enabled="True">
														</ajaxToolkit:FilteredTextBoxExtender>
													</td>
													<td>
														Fecha Factura
													...
													<td>
														<asp:TextBox ID="txt_fecha_factura_intereses" runat="server" Width="70px"></asp:TextBox>
														<asp:RequiredFieldValidator ID="rfv_fecha_factura_intereses" runat="server" CssClass="error" Text="*" ErrorMessage="Fecha Factura Intereses" ControlToValidate="txt_fecha_factura_intereses"></asp:RequiredFieldValidator>
													</td>
													<td>
														<asp:ImageButton ID="btn_fecha_factura_intereses" runat="server" ImageUrl="~/imagenes/sistema/gif/calendario.gif" CausesValidation="False" />
														<ajaxToolkit:CalendarExtender ID="cal_fecha_factura_intereses" runat="server" TargetControlID="txt_fecha_factura_intereses" CssClass="calendario" Format="dd/MM/yyyy" PopupButtonID="btn_fecha_factura_intereses" />
													</td>
													<td>
														Monto Factura
													</td>
													<td>
														<asp:TextBox ID="txt_monto_factura_intereses" runat="server" Width="100px" MaxLength="10" onkeyup="format(this);" onchange="format(this);" onblur="calcularMontoFinanciar();"></asp:TextBox>
														<asp:RequiredFieldValidator ID="rfv_monto_factura_intereses" runat="server" CssClass="error" Text="*" ErrorMessage="Monto Factura Intereses" ControlToValidate="txt_monto_factura_intereses"></asp:RequiredFieldValidator>
														<ajaxToolkit:FilteredTextBoxExtender ID="filter_monto_factura_intereses" runat="server" TargetControlID="txt_monto_factura_intereses" FilterType="Custom, Numbers" ValidChars='<%= System.Globalization.CultureInfo.CreateSpecificCulture("es-CL").NumberFormat.NumberGroupSeparator %>' Enabled="True">
														</ajaxToolkit:FilteredTextBoxExtender>
													</td>
												</tr>
											</table>
											<table class="tabla-normal">
												...
												<tr>
													...
													<td>
														<asp:TextBox ID="txt_factura_gastos" runat="server" Width="100px" MaxLength="10" OnTextChanged="txt_factura_gastos_TextChanged"></asp:TextBox>
														<ajaxToolkit:FilteredTextBoxExtender ID="filter_factura_gastos" runat="server" TargetControlID="txt_factura_gastos" FilterType="Custom, Numbers" ValidChars='<%= System.Globalization.CultureInfo.CreateSpecificCulture("es-CL").NumberFormat.NumberGroupSeparator %>' Enabled="True">
														</ajaxToolkit:FilteredTextBoxExtender>
													</td>
													<td>
														Fecha Factura
													...
													<td>
														<asp:ImageButton ID="btn_fecha_factura_gastos" runat="server" ImageUrl="~/imagenes/sistema/gif/calendario.gif" CausesValidation="False" />
														<ajaxToolkit:CalendarExtender ID="cal_fecha_factura_gastos" runat="server" TargetControlID="txt_fecha_factura_gastos" CssClass="calendario" Format="dd/MM/yyyy" PopupButtonID="btn_fecha_factura_gastos" />
													</td>
													<td>
														Monto Factura
													</td>
													<td>
														<asp:TextBox ID="txt_monto_factura_gastos" runat="server" Width="100px" MaxLength="10" OnTextChanged="txt_monto_factura_gastos_TextChanged" AutoPostBack="true"></asp:TextBox>
														<ajaxToolkit:FilteredTextBoxExtender ID="filter_monto_factura_gastos" runat="server" TargetControlID="txt_monto_factura_gastos" FilterType="Custom, Numbers" ValidChars='<%= System.Globalization.CultureInfo.CreateSpecificCulture("es-CL").NumberFormat.NumberGroupSeparator %>' Enabled="True">
														</ajaxToolkit:FilteredTextBoxExtender>
													</td>
												</tr>
											</table>
