...
{
	public partial class Alzamiento_20190_Especial : System.Web.UI.Page
	{
		...
		protected void Busca_Operacion()
		{
			...
			if (garantia != null)
			{
				...
				if (DateTime.TryParse(garantia.Ing_alza_PH_registro, out fecha))
					this.txt_fecha_inscripcion_ph.Text = fecha.ToShortDateString();
				else
					this.txt_fecha_inscripcion_ph.Text = "";
			}
		}
