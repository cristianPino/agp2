<%@ Page Title="" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="Ingreso_garantia_tanner.aspx.cs" Inherits="sistemaAGP.Ingreso_garantia_tanner" Culture="es-CL" UICulture="es-CL" Theme="SkinAdm" %>
									...
									<asp:Panel ID="pnl_datos_negocio" runat="server" Visible="False">
										...
										<table class="tabla-normal">
											<tr>
												...
												<td>
													<asp:TextBox ID="txt_factura" runat="server" Width="100px" MaxLength="11" onkeyup="format(this);" onchange="format(this);"></asp:TextBox>
