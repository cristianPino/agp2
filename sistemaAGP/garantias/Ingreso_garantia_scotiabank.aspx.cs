...
{
	public partial class Ingreso_garantia_scotiabank : System.Web.UI.Page
    {
		...
		protected void Carga_Operacion(Garantia garantia)
		{
            ...
            if (DateTime.TryParse(garantia.Fecha_primera, out fecha))
                this.txt_f_primera.Text = fecha.ToShortDateString();
            else
                this.txt_f_primera.Text = "";

            if (DateTime.TryParse(garantia.Fecha_ultima, out fecha))
                this.txt_f_ultima.Text = fecha.ToShortDateString();
            else
                this.txt_f_ultima.Text = "";
            ...
            this.txt_f_pagare.Text = garantia.Fecha_pagare.ToString();

         
            if (DateTime.TryParse(garantia.Fecha_pagare, out fecha))
                this.txt_f_pagare.Text = fecha.ToShortDateString();
            else
                this.txt_f_pagare.Text = "";

            this.txt_cant_cuotas.Text = Convert.ToInt32(garantia.N_cuotas).ToString();

            this.txt_dia.Text = garantia.Dia.ToString();
            this.txt_tasa.Text = garantia.Tasa.ToString();
            this.txt_v_cuotas.Text = garantia.Valor_Cuotas.ToString();
            this.txt_c_pagare.Text = garantia.Capital_pagare.ToString();
        ...
        //protected void txt_factura_TextChanged1(object sender, EventArgs e)
        //{
        //    if (this.txt_factura.Text != "")
        //    {
        ...
        protected void txt_f_pagare_TextChanged(object sender, EventArgs e)
        {

        }

        protected void txt_cant_cuotas_TextChanged(object sender, EventArgs e)
        {
            if (this.txt_f_primera.Text != "" && this.txt_cant_cuotas.Text != "")
                this.txt_f_ultima.Text = string.Format("{0:dd/MM/yyyy}", Convert.ToDateTime(this.txt_f_primera.Text).AddMonths(Convert.ToInt32(this.txt_cant_cuotas.Text) - 1));
        }

        protected void txt_v_cuotas_TextChanged(object sender, EventArgs e)
        {

        }

        protected void txt_f_primera_TextChanged(object sender, EventArgs e)
        {
            if (this.txt_f_primera.Text != "" && this.txt_cant_cuotas.Text != "")
                this.txt_f_ultima.Text = string.Format("{0:dd/MM/yyyy}", Convert.ToDateTime(this.txt_f_primera.Text).AddMonths(Convert.ToInt32(this.txt_cant_cuotas.Text) - 1));
        ...
        protected void txt_f_ultima_TextChanged(object sender, EventArgs e)
        {

        }

        protected void txt_c_pagare_TextChanged(object sender, EventArgs e)
        {
        ...
        protected void txt_dia_TextChanged(object sender, EventArgs e)
        {
