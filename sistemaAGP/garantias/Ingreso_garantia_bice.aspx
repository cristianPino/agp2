<%@ Page Title="" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="Ingreso_garantia_bice.aspx.cs" Inherits="sistemaAGP.Ingreso_garantia_bice" Culture="es-CL" UICulture="es-CL" Theme="SkinAdm" %>
									...
									<asp:Panel ID="pnl_datos_negocio" runat="server" Visible="False">
										...
										<table class="tabla-normal">
											<tr>
												...
												<td>
													<% if (this.dl_tipo_doc_fundante.SelectedValue == "FACT") { %>
													<asp:TextBox ID="txt_factura" runat="server" Width="100px" OnTextChanged="txt_factura_TextChanged" AutoPostBack="True"></asp:TextBox>
													...
													<% } else { %>
													<asp:TextBox ID="txt_declaracion" runat="server" Width="100px"></asp:TextBox>
													<% } %>
												...
												<td>
													<asp:TextBox ID="txt_monto_factura" runat="server" Width="100px" OnTextChanged="txt_monto_factura_TextChanged" AutoPostBack="True"></asp:TextBox>
