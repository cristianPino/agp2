...
{
	public partial class Ingreso_garantia_tanner : System.Web.UI.Page
    {
		...
		protected void Add_Operacion()
		{
			...
			if (add != 0)
			{
				...
				add_or = new EstadooperacionBC().add_estado_orden(Convert.ToInt32(add), 10, ViewState["tipo_operacion"].ToString(), "", (string)(Session["usrname"]));//RECEPCION PRENDA
