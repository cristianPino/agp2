...
namespace sistemaAGP
{
	public partial class wucPersona : System.Web.UI.UserControl
	{
		...
		public bool Guardar_Form()
		{
            ...
            string persona = new PersonaBC().add_persona(Convert.ToDouble(this.txt_rut.Text), this.txt_dv.Text, 1, "", this.txt_nombre.Text, this.txt_paterno.Text, this.txt_materno.Text, this.dl_sexo.SelectedValue, "0", this.txt_nacionalidad.Text, this.txt_profesion.Text, this.dl_estado_civil.SelectedValue, "", "", "", "", "", "", "0",this.giro);
