<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucIncidenciaResumenIngresador.ascx.cs" Inherits="sistemaAGP.controles.wucIncidenciaResumenIngresador" %>
