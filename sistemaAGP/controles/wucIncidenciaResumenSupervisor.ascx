<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucIncidenciaResumenSupervisor.ascx.cs" Inherits="sistemaAGP.controles.wucIncidenciaResumenSupervisor" %>
