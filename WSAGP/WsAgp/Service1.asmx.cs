    ...
    public class Service1 : System.Web.Services.WebService
    {
        ...
        //public string getInformacionPermiso(string user, string pswd, string rut, string patente)
        {
            if (ValidarUsuario(user, pswd))
            {
                try
                {
                    //string add = new OperacionXMLBC().act_valor_patente_por_motor(FuncionGlobal.FuctionDesEncriptar(motor), Convert.ToInt32(FuncionGlobal.FuctionDesEncriptar(valor)), FuncionGlobal.FuctionDesEncriptar(patente));
                    //return add;
                    return "descomentar arriba";
        ...
        //public string getInformacionPermiso(string user, string pswd, string rut, string patente)
        {
            if (ValidarUsuario(user, pswd))
            {
                try
                {
                    //string add = new OperacionXMLBC().act_valor_patente_por_numero_operacion( Convert.ToInt32( FuncionGlobal.FuctionDesEncriptar(numero_operacion.Trim())), Convert.ToInt32(FuncionGlobal.FuctionDesEncriptar(valor)), FuncionGlobal.FuctionDesEncriptar(patente));
                    //return add;
                    return "descomentar arriba";
            ...
            if (ValidarUsuario(user, pswd))
            {
                try
                {
                    ...
                    if (mOperacion != null)
                    {
                        ...
                        pc.datosVehiculo.Transmision = mOperacion.Vehiculo.Transmision;
                        pc.datosVehiculo.Equipamiento = mOperacion.Vehiculo.Equipamiento;
                        //Datos Factura
            ...
            if (ValidarUsuario(user, pswd))
            {
                try
                {
                    ...
                    if (mOperacion != null)
                    {
                        ...
                        w.WriteElementString("Equipamiento", mOperacion.Vehiculo.Equipamiento.ToString());
                        w.WriteElementString("Transmision", mOperacion.Vehiculo.Transmision.ToString());
                        w.WriteEndElement();
            ...
            if (ValidarUsuario(user, pswd))
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        w.WriteStartElement("operacion");
                        w.WriteStartElement("error");
                        w.WriteElementString("descripcion", "No se encontró el numero de motor buscada");
                        w.WriteEndElement();
                        w.WriteEndElement();
                        w.WriteEndDocument();
                        w.Flush();
        ...
        [System.Web.Services.WebMethod()]
        public PermisoCirculacion getInformacionNumeroOperacionXML(string user, string pswd, string numero_operacion)
        //public PermisoCirculacion getInformacionPermisoXML(string user, string pswd, string rut, string patente)
        {
            if (ValidarUsuario(user, pswd))
            {
                ...
                {
                    //OperacionXML mOperacion = new OperacionXMLBC().getOperacionXML(Convert.ToInt32(FuncionGlobal.FuctionDesEncriptar(rut)), FuncionGlobal.FuctionDesEncriptar(patente));
                   // descomentar este OperacionXML mOperacion = new OperacionXMLBC().getOperacionXML_Por_numero_operacion(Convert.ToInt32(FuncionGlobal.FuctionDesEncriptar(numero_operacion.Trim())));
                    OperacionXML mOperacion = new OperacionXML();  //eliminar este
                    if (mOperacion != null)
                    {
                        PermisoCirculacion pc = new PermisoCirculacion();
                        pc.idOperacion = mOperacion.Id_solicitud;
                ...
                try
                {
                   ...
                   // descomentar este OperacionXML mOperacion = new OperacionXMLBC().getOperacionXML_Por_numero_operacion(Convert.ToInt32( FuncionGlobal.FuctionDesEncriptar(numero_operacion.Trim())));
                    ...
                    else
                    {
                        ...
                        w.WriteStartElement("operacion");
                        w.WriteStartElement("error");
                        w.WriteElementString("descripcion", "No se encontró el numero de operacion.");
                        w.WriteEndElement();
                        w.WriteEndElement();
                        w.WriteEndDocument();
                        w.Flush();
